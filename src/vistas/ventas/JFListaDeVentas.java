...
public class JFListaDeVentas extends javax.swing.JFrame {

    private final ModeloVenta modeloVenta;
    
    public JFListaDeVentas() {
        ...
        modeloVenta= new ModeloVenta("TODOS");
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Lista de Ventas");
        ...
        btnVer.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        btnVer.setForeground(new java.awt.Color(71, 120, 197));
        btnVer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/icons8_edit_file_32px_2.png"))); // NOI18N
        btnVer.setText("Ver");
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        if(rsDia.getDatoFecha()==null)
            modeloVenta.establecerDatos("DIADEHOY", new Date());
        else 
           modeloVenta.establecerDatos("DIASELECCIONADO", rsDia.getDatoFecha());
        
    }//GEN-LAST:event_formWindowActivated

    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        
        JFVenta jFVenta = new JFVenta(null, "NUEVO");
    ...
    private void btnVerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerActionPerformed
        ...
        try {
            if(tblVentas.getSelectedRow()!=-1){
                ...
                WarningConfirmAlert alertaWarning = new WarningConfirmAlert(this, true, "¿Desea ver la venta?");
                alertaWarning.setVisible(true);
                
                if(alertaWarning.recibe()){

                    Venta venta = TablaVenta.buscaVenta(Integer.parseInt(tblVentas.getValueAt(tblVentas.getSelectedRow(), 1).toString()), "");
                    
                    JFVenta jFVenta = new JFVenta(venta, "VER");
                    jFVenta.setVisible(true);
                ...
                new alertas.WarningAlert(this, true, "Debe seleccionar una venta").setVisible(true);
            }
        ...
        try {
            if(tblVentas.getSelectedRow()!=-1){
                ...
                if(alertaWarning.recibe()){
                    ...
                    TablaVenta tab = new TablaVenta();

                    if(tab.eliminarventa(Integer.parseInt(tblVentas.getValueAt(tblVentas.getSelectedRow(), 1).toString()))==1)
                        new alertas.SuccessAlert(this, true, "Venta eliminada correctamente").setVisible(true);
                    else
                        new alertas.ErrorAlert(this, true, "No se pudo eliminar la venta").setVisible(true);
    ...
    private void btnReporte1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporte1ActionPerformed
        try {
            ...
            WarningConfirmAlert alertaWarning = new WarningConfirmAlert(this, true, "¿Desea generar reporte de esta venta?");
            alertaWarning.setVisible(true);

                if(alertaWarning.recibe()){
                    GenerarReportes.reportes("REPORTE_VENTAS",Integer.parseInt(tblVentas.getValueAt(tblVentas.getSelectedRow(), 1).toString()),null);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFListaDeVentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFListaDeVentas().setVisible(true);
            }
        });
    }
