...
public class JFListaDeInsumos extends javax.swing.JFrame {

    private final ModeloInsumo modeloInsumo;
    
    public JFListaDeInsumos() {
        ...
        modeloInsumo= new ModeloInsumo("TODOS");
        
        tblInsumos.setModel(modeloInsumo);
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Lista de Insumos");
        ...
        tblInsumos.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ...
        tblInsumos.setGridColor(new java.awt.Color(255, 255, 255));
        tblInsumos.setRowHeight(22);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        modeloInsumo.establecerDatos(txtBusqueda.getText().toUpperCase().trim(),"TODOS");
    }//GEN-LAST:event_formWindowActivated

    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        JFInsumo JFInsumo = new JFInsumo(null, "NUEVO");
        JFInsumo.setVisible(true);
        ...
        try {
            if(tblInsumos.getSelectedRow()!=-1){
                ...
                if(alertaWarning.recibe()){
                    ...
                    Insumo insumo=TablaInsumo.buscaInsumo(Integer.parseInt(tblInsumos.getValueAt(tblInsumos.getSelectedRow(), 1).toString()));

                    JFInsumo JFInsumo = new JFInsumo(insumo, "MODIFICAR");
                    JFInsumo.setVisible(true);
        ...
        try {
            if(tblInsumos.getSelectedRow()!=-1){
                ...
                if(alertaWarning.recibe()){
                    ...
                    TablaInsumo tab = new TablaInsumo();

                    if(tab.eliminarInsumo(Integer.parseInt(tblInsumos.getValueAt(tblInsumos.getSelectedRow(), 1).toString()))==1)
                       mensaje="Insumo eliminado correctamente";
                    else
                        mensaje="No se pudo eliminar el insumo";

                    new alertas.SuccessAlert(this, true, mensaje).setVisible(true);
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
        try {
            ...
            WarningConfirmAlert alertaWarning = new WarningConfirmAlert(this, true, "¿Desea generar reporte de insumos?");
            alertaWarning.setVisible(true);
            ...
            if(alertaWarning.recibe()){
                ...
                */
                GenerarReportes.reportes("REPORTE_INSUMOS",0,null);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFListaDeInsumos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFListaDeInsumos().setVisible(true);
            }
        });
    }
