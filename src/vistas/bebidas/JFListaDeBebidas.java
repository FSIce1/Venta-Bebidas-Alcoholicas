...
public class JFListaDeBebidas extends javax.swing.JFrame {

    private final ModeloTrago modeloTrago;
    
    public JFListaDeBebidas() {
        initComponents();
        ...
        modeloTrago= new ModeloTrago("TODOS");
        
        tblTragos.setModel(modeloTrago);
        tblTragos.getTableHeader().setReorderingAllowed(false);
    ...
    private void initComponents() {
        ...
        tblTragos = new javax.swing.JTable();
        ...
        jLabel14.setText("Lista de Bebidas");
        ...
        tblTragos.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        tblTragos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tblTragos.setGridColor(new java.awt.Color(255, 255, 255));
        tblTragos.setRowHeight(22);
        jScrollPane1.setViewportView(tblTragos);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        modeloTrago.establecerDatos(txtBusqueda.getText().toUpperCase().trim(),"TODOS");
    }//GEN-LAST:event_formWindowActivated

    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        JFBebida JFBebida = new JFBebida(null, "NUEVO");
        JFBebida.setVisible(true);
    }//GEN-LAST:event_btnNuevoActionPerformed

    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            if(tblTragos.getSelectedRow()!=-1){
                ...
                if(alertaWarning.recibe()){
                    ...
                    Trago trago=TablaTrago.buscaTrago(Integer.parseInt(tblTragos.getValueAt(tblTragos.getSelectedRow(), 1).toString()));

                    JFBebida JFBebida = new JFBebida(trago, "MODIFICAR");
                    JFBebida.setVisible(true);
        ...
        try {
            if(tblTragos.getSelectedRow()!=-1){
                ...
                if(alertaWarning.recibe()){
                    ...
                    TablaTrago tab = new TablaTrago();

                    if(tab.eliminarTrago(Integer.parseInt(tblTragos.getValueAt(tblTragos.getSelectedRow(), 1).toString()))==1)
                        new alertas.SuccessAlert(this, true, "Bebida eliminada correctamente").setVisible(true);
                    else
                        new alertas.ErrorAlert(this, true, "No se pudo eliminar la bebida").setVisible(true);
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
        try {
            ...
            WarningConfirmAlert alertaWarning = new WarningConfirmAlert(this, true, "¿Desea generar reporte de bebidas?");
            alertaWarning.setVisible(true);
            ...
            if(alertaWarning.recibe()){
                ...
                */
                GenerarReportes.reportes("REPORTE_BEBIDAS",0,null);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFListaDeBebidas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFListaDeBebidas().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblTragos;
