...
public class WarningConfirmAlert extends javax.swing.JDialog {

    private boolean modo;
    
    public WarningConfirmAlert(java.awt.Frame parent, boolean modal,String mensaje) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningConfirmAlert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningConfirmAlert dialog = new WarningConfirmAlert(new javax.swing.JFrame(), true,"");
